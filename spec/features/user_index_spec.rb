...
describe "Visit the users' index page", type: :feature do
  before :each do
    @user1 = User.create(name: 'Nick Jhons', photo: 'https://randomuser.me/api/portraits/men/51.jpg',
                         bio: 'I am a software engineer with more than 3 years of experience on web development.')
    @user2 = User.create(name: 'Jenna Lenz', photo: 'https://randomuser.me/api/portraits/women/54.jpg',
                         bio: 'My name is Jenna Lenz, I am a Frontend Developer with a vast experience on React .')
  end
